...
function EventInfoForm({ nextStep, handleFormData, values }) {
  ...
  const formValidation = () => {
    ...
    if(values.eventName.trim().length < 5){
        eventNameErr.firstNameShort = "Evenemanget måste ha ett namn på minst 5 bokstäver";
        isValid = false
    }
      ...
      <div className={style.form}>
        ...
        <div className={style.categoryDiv}>
          ...
          {Object.keys( categoryErr).map((key)=>{
                return <div key={key} style={{color : "red"}}>{ categoryErr[key]}</div>
            })}  
        </div>      
        ...
        {Object.keys(eventNameErr).map((key)=>{
              return <div key={key} style={{color : "red"}}>{eventNameErr[key]}</div>
          })}   
        </div>
          ...
          <div className={style.inputDateTime}>  
            <div className={style.dateTimeBox}>
              ...
              {Object.keys(dateErr).map((key)=>{
                return <div key={key} style={{color : "red"}}>{dateErr[key]}</div>
              })} 
              </div>
            </div>
            ...
            <div className={style.dateTimeBox}>
              ...
              <div className={style.time}>
                ...
                {Object.keys(timeErr).map((key)=>{
                  return <div key={key} style={{color : "red"}}>{timeErr[key]}</div>
                })} 
              </div>
            </div>
          </div>
        ...
        <div className={style.title}>Adress
          <div className={style.adressContainer}>
            <div className={style.LocationContainer}>
              ...
              return <div key={key} style={{color : "red"}}>{locationErr[key]}</div>
              })} 
            </div>
            ...
            <div className={style.cityContainer}>
              ...
              return <div key={key} style={{color : "red"}}>{cityErr[key]}</div>
              })} 
            </div>
          </div>
        </div>
        ...
        <div className={style.priceAndParticipants}>
          <div className={style.priceParticipantsInner}>   
            <div className={style.priceParticipantsSymbol}><Payments/></div>
          ...
          <div className={style.priceParticipantsInner}>
            <div className={style.priceParticipantsSymbol}><Participants/></div>
            <div className={style.priceAndParticipantsBox}>
              <p className={style.textPriceAndParticipants}>ANTAL DELTAGARE</p>
              <p className={style.textOptionally}>Valfritt</p>
            </div>
              <input
                name="price"
