  ...
  return (
    <div className={style.imgWholeDiv}>
      ...
      <div className={style.imgDiv}>
        ...
        <p className={style.roll}>
          UX Designer{" "}
          <Image src="/TildaIcon.png" alt="TildaIcon" width={16} height={17} />
        </p>
      </div>
      <div className={style.imgDiv}>
      ...
      <div className={style.imgDiv}>
        ...
        <p className={style.roll}>
          Utvecklare{" "}
          <Image src="/JulioIcon.png" alt="JulioIcon" width={12} height={12} />
        </p>
      </div>
      <div className={style.imgDiv}>
        <Image
      ...
      <div className={style.imgDiv}>
        <Image
          ...
          height={160}
        />
        <p className={style.name}>Nicole Silfverling</p>
        <p className={style.roll}>
          Utvecklare{" "}
          <Image
            src="/NicoleIcon.png"
